<div class="user-new">
	...
	<form name="user-form" class="form-horizontal" >
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="email" ng-model="user.username" name="username" id="username" required>
				<input type="email" ng-model="user.email" name="email" id="email" required>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<input type="text" ng-model="user.passwordConfirm" name="password-confirm" id="password-confirm" required >
			</div>
		</div>
